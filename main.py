...
async def set_commands():
    ...
    commands = [BotCommand(command='start', description='Старт'),
                ...
                BotCommand(command='add', description='Добавить проект'),
                BotCommand(command='change', description='Изменить проект'),
                BotCommand(command='remove', description='Удалить проект')]
